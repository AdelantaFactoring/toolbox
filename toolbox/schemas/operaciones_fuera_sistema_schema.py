"""
📊 Schemas Pydantic V2 - OperacionesFueraSistema
...
class OperacionesFueraSistemaSchema(BaseModel):
    """Schema base para OperacionesFueraSistema - COPIADO EXACTO DE V1"""

    model_config = ConfigDict(arbitrary_types_allowed=True)

    # Campos copiados exactos de V1
    ...
    # Validadores copiados exactos de V1
...
OperacionesFueraSistemaCalcularSchema = OperacionesFueraSistemaSchema
